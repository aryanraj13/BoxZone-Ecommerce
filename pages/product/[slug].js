...
export default function Page({addToCart,product,variants}) {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/418VXvOd2HL.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">BoxZone</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Fill your Box (XL/Blue)</h1>
        ...
        <div className="flex">
          ...
          <button onClick={()=>{addToCart(slug,1,499,'Fill your Box(XL/Red)','XL',"Red")}} className="flex ml-4 text-white bg-purple-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Add to Cart</button>
