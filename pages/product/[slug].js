  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">BoxZone</h2>
        ...
        <div className="flex">
          ...
          <button onClick={()=>{buyNow(slug,1,product.price,product.title,product.size,product.color)}} className="flex ml-8 text-white bg-purple-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Buy Now</button>
          <button onClick={()=>{toast.success('Item added to cart!', { position: "bottom-center", autoClose: 1300, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined}); addToCart(slug,1,product.price,product.title,product.size,product.color);}} className="flex ml-4 text-white bg-purple-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded">Add to Cart</button>
        ...
        <div className='pin mt-6 flex space-x-2 text-sm'>
          <input onChange={onChangePin} placeholder='Enter yout pincode here' className='px-2 border-2 border-purple-400 rounded-md' type='text'/>
          <button onClick={checkServiceablity} className=' text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded'>Check</button>
        </div>
