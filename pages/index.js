...
export default function Home() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Fill your boxes with BoxZone.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Fill your boxes with any type of stuff that your want from out zone and get out of zone.</p>
    </div>
