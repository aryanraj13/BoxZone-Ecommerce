...
focus:border-purple-500 focus:ring-2 focus: ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-transition-colors duration-200 ease-in-out" placeholder="State" required/>
  ...
  <h5 className='my-4'>2. Review Cart Item(s)</h5>
    {/* //todo cart */}
      ...
      <div className=" sidebar p-2 pl-8 bg-purple-50  z-10">
        ...
        <label htmlFor="remember" className="ml-2 text-sm  text-gray-900 dark:text-gray-300">I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a>.</label>
    </div>
